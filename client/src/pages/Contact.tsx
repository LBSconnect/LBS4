  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      <SEO
        ...
        canonical="/contact"
        description="Contact LBS Business Services Center at 616 FM 1960 Rd W, Ste 101, Houston, TX 77090. Call (281) 836-5357 or email info@lbsconnect.net. Open Mon–Fri 8:30 AM–6 PM, Sat 9 AM–3 PM."
      />
      <Header />
