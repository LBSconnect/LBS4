...
export default function Contact() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Check captcha if configured. Skipped when the widget itself failed to
    // load/render (captchaError) — the submit button is enabled in that case
    // too (see its disabled= below), and the server still verifies the
    // token server-side when one is present.
