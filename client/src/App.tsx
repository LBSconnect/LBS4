...
import PortalForceChangePassword from "@/pages/i9-portal/PortalForceChangePassword";
  ...
  return (
    <>
      ...
      <Switch>
        ...
        <Route path={PORTAL_ROUTES.forceChangePassword} component={PortalForceChangePassword} />
