...
// Store opens 8am weekdays / 8am Saturday; first bookable hourly slot is 8am both days.
...
// Mon–Fri: slots 8am–4pm (business open 8am, closes 5pm) | Sat: slots 8am–3pm (open 8am, closes 4pm) | Sun: closed
function getAvailableTimeSlots(date: Date, serviceSlug?: string): string[] {
  ...
  else           { startHour = 8; endHour = 16; } // Mon–Fri: last slot 4pm (closes 5pm)
